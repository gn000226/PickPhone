...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    //顏色名
    let colorString = [ "大西洋藍","共九桃","印度洋藍","李太黑","韓粉","無腦綠","歐瑞橘","潘迎紫","地中海藍","綠豆黃","請選擇" ]
    ...
    override func viewDidLoad() {
        ...
        self.ivPhoneBackground.contentMode = .scaleAspectFit
        self.ivPhoneBackground.isHidden = true
        
        //宣告UIImage及UIImageView，並給與圖
        ...
        colorImageView.frame = ivPhoneBackground.bounds
        ...
        phoneColorView.mask = colorImageView    //.mask > 遮罩，遮色
    }
    /* 設定collectionView長度 **/
    ...
    @IBAction func select12Pro(_ sender: UIButton) {
        self.ivPhoneBackground.isHidden = false
        self.ivPhoneBackground.image = UIImage(named: "iphone-12-pro-Back")
        let image12Pro = UIImage(named: "iphone-12-pro-Color")
        let colorImageView = UIImageView(image: image12Pro)
